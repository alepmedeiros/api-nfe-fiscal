...
begin
  FParent := Parent;
  case FParent.Component.NotaFiscal.NFe.Emit.CRT of
    crtSimplesNacional : Self.Accept(TModelFiscaoNFeRegrasFisicaisICMSSimples.New); 
    crtRegimeNormal : Self.Accept(TModelFiscaoNFeRegrasFisicaisICMSRegimeNormal.New); 
