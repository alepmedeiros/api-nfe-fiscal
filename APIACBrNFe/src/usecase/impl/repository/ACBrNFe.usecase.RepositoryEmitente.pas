...
constructor TRepositoryEmitente.Create(Conf: iActionNFe; Entity: iFactoryEntity);
begin
  FConf := Conf;
  FEntity := Entity;
end;
...
class function TRepositoryEmitente.New(Conf: iActionNFe; Entity: iFactoryEntity): iCommand;
begin
